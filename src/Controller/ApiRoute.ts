...
export default class ApiRoute extends Core.Route.BaseRoute implements Core.Route.IRoute {
    doAction(action: string, method: string, next: Core.Route.RequestHandler) {
        switch (action) {
            case 'uploadBase64':
